...
class RoomConnection (room1: Room, room2: Room) {
    ...
    init {
        ...
        val room1_coord_X_end = room1.roomPreset.size_X + room1.coord_X
        val room1_coord_Y_end = room1.roomPreset.size_Y + room1.coord_Y


        val room2_coord_X_end = room2.roomPreset.size_X + room2.coord_X
        val room2_coord_Y_end = room2.roomPreset.size_Y + room2.coord_Y

        //Проверка соприкосновения по левой стене комнаты 1 с правой стеной комнаты 2
        if (room1.coord_X == room2_coord_X_end) {
            coord_X_1 = 0
            coord_X_2 = room2.roomPreset.size_X - 1
        ...
        if (room1_coord_X_end == room2.coord_X) {
            coord_X_1 = room1.roomPreset.size_X - 1
            coord_X_2 = 0
            coord_Y_1 = genRandomDoor(
                room1.coord_Y,
                room1_coord_Y_end,
        ...
        if (room1.coord_Y == room2_coord_Y_end) {
            coord_Y_1 = 0
            coord_Y_2 = room2.roomPreset.size_Y - 1
        ...
        if (room1_coord_Y_end == room2.coord_Y) {
            coord_Y_1 = room1.roomPreset.size_Y - 1
            coord_Y_2 = 0
            coord_X_1 = genRandomDoor(
                room1.coord_X,
                room1_coord_X_end,
